import{c as j,a7 as u,a1 as S,aK as A,r as s,ea as E,bu as M,eb as W,Z as N,bD as F,ec as O,m as e,a5 as a,ed as R,q as w,bd as B,a6 as L}from"./eljox9y9liclbxjs.js";import{a8 as H,R as q}from"./mov0dqfy71k4mkbp.js";const z={flags:{failwhaleBypassEnabled:!1,sharingEnabled:!1}},D=j()((i,n)=>({...z,updateFlagValue:(l,h)=>{const c=n().flags;i({flags:{...c,[l]:h}})}}));function K(){const i=S(),n=A(),l=D(o=>o.flags.failwhaleBypassEnabled),[h,c]=s.useState(!1),[T,C]=s.useState(!1),d=E(),m=s.useRef(b[Math.floor(Math.random()*b.length)]),[r,k]=s.useState(!1),[x,g]=s.useState(!1),[p,P]=s.useState(!1),f=M();s.useEffect(()=>{document.title="ChatGPT",C(!0)},[]),s.useEffect(()=>{d(()=>{c(!0)},1e3)},[d]);const G=s.useCallback(o=>{o.preventDefault();const v=o.target,I=W(v.email.value);g(!0),N.getLoginLink(I).catch(y=>{n.danger(y instanceof F?y.originalMessage:O)}).finally(()=>{g(!1),k(!0)})},[n]);return T?e.jsx(J,{children:e.jsxs("div",{className:"relative flex h-full w-full overflow-hidden",children:[e.jsxs(U,{children:[e.jsx("div",{className:"text-3xl font-semibold",children:e.jsx(a,{...t.title})}),e.jsx("a",{href:"https://share.hsforms.com/13gyIEVN5SrScw-iVvCgIew4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:e.jsx(a,{...t.getNotified})}),e.jsx("div",{className:"flex",children:e.jsx("div",{className:"font-bold",children:m.current.prompt})}),e.jsx("div",{className:"max-w-lg pb-8",children:e.jsx(R,{value:m.current.completion,typing:h,speed:150,chunk:!0})})]}),l&&e.jsx(V,{$show:p,children:e.jsxs("div",{className:"relative m-6 flex w-full flex-col justify-center gap-4 text-gray-800 lg:max-w-sm lg:rounded-lg lg:border lg:p-6",children:[f&&e.jsx("h3",{children:e.jsx(a,{...t.chatGPTPlus})}),!f&&e.jsxs("button",{className:"text-center text-xl font-semibold lg:text-left",onClick:()=>P(o=>!o),children:[e.jsx(a,{...t.chatGPTPlus}),e.jsx(H,{className:w("icon-lg absolute right-0 top-0",!p&&"rotate-180")})]}),e.jsxs("div",{className:"m-auto flex w-full max-w-md flex-col gap-4 rounded-md border p-6 lg:border-0 lg:p-0",children:[!r&&e.jsx("p",{children:e.jsx(a,{...t.addEmail})}),r&&e.jsx("p",{children:e.jsx(a,{...t.allSet,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"})}})}),e.jsxs("form",{onSubmit:G,children:[e.jsx("label",{htmlFor:"email",className:"hidden text-sm font-semibold text-gray-700",children:e.jsx(a,{...t.searchCandidates})}),e.jsxs("div",{className:"mt-1 flex rounded-md shadow-sm",children:[e.jsx("div",{className:"relative flex flex-grow items-stretch focus-within:z-10",children:e.jsx("input",{type:"email",name:"email",id:"email",className:w("form-input block w-full rounded-none rounded-l-md border-gray-300 focus:border-green-500 focus:ring-green-500 sm:text-sm",{"opacity-50":r}),required:!0,disabled:r,placeholder:i.formatMessage(t.emailPlaceholder)})}),e.jsx(B,{as:"button",color:"primary",className:"rounded-none rounded-r-md",type:"submit",disabled:r,loading:x,children:e.jsx("span",{className:"flex flex-row items-center space-x-1.5",children:r?e.jsxs(e.Fragment,{children:[e.jsx(q,{className:"icon-sm"}),e.jsx(a,{...t.sent})]}):e.jsx(a,{...t.sendLink})})})]})]}),e.jsx("p",{className:"text-sm",children:e.jsx(a,{...t.notSubscriber,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"}),waitlist:o=>e.jsx("a",{href:"https://share.hsforms.com/1_-FpF2GTRJORIb83N3aK7Q4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:o})}})})]})]})})]})}):null}const J=u.div`w-full h-full overflow-auto`,U=u.div`flex w-full max-w-lg mx-auto shrink-0 flex-col gap-6 overflow-auto px-6 pt-20 lg:w-3/5 lg:px-14 lg:pt-32 lg:max-w-none`,V=u.div`absolute bottom-0 w-full lg:w-auto lg:relative flex flex-grow items-center justify-center bg-white rounded-t-xl lg:rounded-none transition-transform
...
3. ChatGPT can predict the future with 100% accuracy.`}];export{K as C};
//# sourceMappingURL=ii1qyxy305dl6uyj.js.map
